...
The following command, for example, creates a descriptor wallet. More information about this command may be found by running `avian-cli help createwallet`.

```
$ avian-cli createwallet "wallet-01"
```
...
| -----------------|:------------------------------------------------------------|
| Linux            | `/home/<user>/.avianv5/wallets`                              |
| Windows          | `C:\Users\<user>\AppData\Local\AvianV5\wallets`            |
| macOS            | `/Users/<user>/Library/Application Support/AvianV5/wallets` |
...
```
$ avian-cli -rpcwallet="wallet-01" encryptwallet "passphrase"
```

Once encrypted, the passphrase can be changed with the `walletpassphrasechange` command.

```
$ avian-cli -rpcwallet="wallet-01" walletpassphrasechange "oldpassphrase" "newpassphrase"
```
...
```
$ avian-cli -named createwallet wallet_name="wallet-01" passphrase="passphrase"
```
...
```
$ avian-cli -rpcwallet="wallet-01" sendtoaddress "tb1qw508d6qejxtdg4y5r3zarvary0c5xw7kxpjzsx" 0.01
error code: -13
error message:
...
```
$ avian-cli -rpcwallet="wallet-01" walletpassphrase "passphrase" 120
```
...
```
$ avian-cli -rpcwallet="wallet-01" backupwallet /home/node01/Backups/backup-01.dat
```
...
```
$ avian-cli restorewallet "restored-wallet" /home/node01/Backups/backup-01.dat
```

After that, `getwalletinfo` can be used to check if the wallet has been fully restored.

```
$ avian-cli -rpcwallet="restored-wallet" getwalletinfo
```
