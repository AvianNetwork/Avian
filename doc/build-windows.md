...
Below are some notes on how to build Avian Core for Windows.
...
way. This will install to `c:\workspace\avian`, for example:

    make install DESTDIR=/mnt/c/workspace/avian
