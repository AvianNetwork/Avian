...
debug log about your I2P configuration and connections. Run `avian-cli help
...
`avian-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `avian-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `avian-cli getpeerinfo`).

You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `avian-cli help getnodeaddresses` for details.
