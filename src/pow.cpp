...
// Minotaurx Algo: Diff adjustment for pow algos (post-dual algo activation)
...
{
    const bool verbose = LogAcceptCategory(BCLog::DUAL_ALGO);
...
// Call correct diff adjust for blocks prior to Dual Algo
...
bool CheckProofOfWorkDualAlgo(uint256 hash, unsigned int nBits, const Consensus::ConsensusParams& params, const POW_TYPE powType)
{
    // dual algo active with LWMA3 as retargetter and different powtargets/algo
    bool fNegative;
    bool fOverflow;
