...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAvianURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + AvianUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAvianURI(info));
}
