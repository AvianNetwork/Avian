...
void BitcoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Avian Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Avian Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open an avian: URI"));
    ...
    if(walletFrame)
    {
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            QString backup_file = GUIUtil::getOpenFileName(this, title_windows, GUIUtil::getDefaultDataDirectory(), name_data_file + QLatin1String(" (*.dat)"), nullptr);
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Avian network.", "", count);
    } else {
        //: A substring of the tooltip.
