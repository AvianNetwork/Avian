...
const QString BITCOIN_IPC_PREFIX("avian:");
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("avian://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'avian://' is not a valid URI. Use 'avian:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // avian: URI
    {
