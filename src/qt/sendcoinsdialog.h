...
private:
    ...
    // Copy PSBT to clipboard and offer to save it (for offline signing workflows)
    void presentPSBT(const PartiallySignedTransaction& psbt);
...
public:
    ...
    // Return values: QMessageBox::Yes for Send, QMessageBox::Save for Create Unsigned, QMessageBox::Cancel for Cancel
    // QMessageBox::Save is reused to mean "Create Unsigned PSBT"
