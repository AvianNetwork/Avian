...
BOOST_FIXTURE_TEST_CASE(ListCoinsTest, ListCoinsTestingSetup)
{
    ...
    // pubkey.
    AddTx(CRecipient{PubKeyDestination{{}}, 1 * COIN, /*subtract_fee=*/false, /*scriptOverride=*/{}});
    {
        LOCK(wallet->cs_wallet);
        list = ListCoins(*wallet);
    }
                     ...
                     std::map<OutputType, size_t>& expected_coins_sizes)
{
    ...
    CWalletTx& wtx = context.AddTx(CRecipient{*dest, amount, /*fSubtractFeeFromAmount=*/true, /*scriptOverride=*/{}});
