...
static UniValue blockToDeltasJSON(const CBlock& block, const CBlockIndex& tip, const CBlockIndex& blockindex, const Consensus::Params& params)
{
    ...
    if (IsDualAlgoEnabled(&tip, params)) {
        const CBlockIndex* p_minotaurx = GetLastBlockIndex4Algo(&tip, POW_TYPE_MINOTAURX);
        const CBlockIndex* p_x16rt = GetLastBlockIndex4Algo(&tip, POW_TYPE_X16RT);
        result.pushKV("difficulty_minotaurx", p_minotaurx ? GetDifficulty(*p_minotaurx) : 1.0);
        result.pushKV("difficulty_x16rt", p_x16rt ? GetDifficulty(*p_x16rt) : 1.0);
    }
...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (avian-cli -rpcclienttimeout=0)",
                {
...
static RPCHelpMan getblockdeltas()
{
    return RPCHelpMan{
        "getblockdeltas",
        "Returns detailed input/output address deltas for each transaction in a block.\n"
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::ARR, "deltas", "Transaction-level deltas", {
                            {RPCResult::Type::OBJ, "", "", {
                        ...
                        {RPCResult::Type::NUM, "difficulty_minotaurx", /*optional=*/true, "MinotaurX difficulty when dual algo is active"},
                        {RPCResult::Type::NUM, "difficulty_x16rt", /*optional=*/true, "X16RT difficulty when dual algo is active"},
                ...
                RPCExamples{
                    HelpExampleCli("getblockdeltas", "\"000000003a7e4493372082e6bc01ede6743f5f58c18e9eea6aa4db7be7b185bb\"")
            + HelpExampleRpc("getblockdeltas", "\"000000003a7e4493372082e6bc01ede6743f5f58c18e9eea6aa4db7be7b185bb\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ChainstateManager& chainman = EnsureAnyChainman(request.context);
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{
        "getblockstats",
        "Compute per block statistics for a given window. All amounts are in avianshis.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", /*optional=*/true, "Average feerate (in avianshis per virtual byte)"},
                {RPCResult::Type::NUM, "avgtxsize", /*optional=*/true, "Average transaction size"},
                {RPCResult::Type::STR_HEX, "blockhash", /*optional=*/true, "The block hash (to check for potential reorgs)"},
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", /*optional=*/true, "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in avianshis per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", /*optional=*/true, "Maximum feerate (in avianshis per virtual byte)"},
                {RPCResult::Type::NUM, "maxtxsize", /*optional=*/true, "Maximum transaction size"},
                {RPCResult::Type::NUM, "medianfee", /*optional=*/true, "Truncated median fee in the block"},
                {RPCResult::Type::NUM, "mediantime", /*optional=*/true, "The block median time past"},
                {RPCResult::Type::NUM, "mediantxsize", /*optional=*/true, "Truncated median transaction size"},
                {RPCResult::Type::NUM, "minfee", /*optional=*/true, "Minimum fee in the block"},
                {RPCResult::Type::NUM, "minfeerate", /*optional=*/true, "Minimum feerate (in avianshis per virtual byte)"},
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (avian-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (avian-cli -rpcclienttimeout=0)",
        {
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable aviand instance that is current with the network tip in a "
