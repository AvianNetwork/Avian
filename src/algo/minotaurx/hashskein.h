...
#ifndef RING_CRYPTO_POW_HASHSKEIN_H
#define RING_CRYPTO_POW_HASHSKEIN_H
...

{
    ...
    CSHA256().Write((unsigned char*)&hash1, 64).Finalize((unsigned char*)&hash2);
    
    return hash2;
}

#endif // RING_CRYPTO_POW_HASHSKEIN_H
