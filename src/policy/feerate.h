...
const std::string CURRENCY_UNIT = "AVN"; // One formatted unit
const std::string CURRENCY_ATOM = "avn"; // One indivisible minimum value unit
...
enum class FeeEstimateMode {
    ...
    BTC_KVB,      //!< Use AVN/kvB fee rate unit
    SAT_VB,       //!< Use avn/vB fee rate unit
};
