/* src/config/ravenlite-config.h.  Generated from ravenlite-config.h.in by configure.  */
/* src/config/ravenlite-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The RavencoinLite Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "RavencoinLite Core"
...
#define PACKAGE_BUGREPORT "https://github.com/RavencoinLite/RavencoinLite"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RavencoinLite Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RavencoinLite Core 2.6.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ravencoinlite"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ravencoinlite.org/"
