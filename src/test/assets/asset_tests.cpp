...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        //- Versions of AVIANCOIN NOT allowed
        BOOST_CHECK(!IsAssetNameValid("RVN", type));
        BOOST_CHECK(!IsAssetNameValid("AVIAN", type));
        BOOST_CHECK(!IsAssetNameValid("AVIANCOIN", type));

        //- Versions of AVIANCOIN ALLOWED
        ...
        BOOST_CHECK(IsAssetNameValid("BLACK_AVIANS", type));
