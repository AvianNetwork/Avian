...
BOOST_FIXTURE_TEST_SUITE(qualifier_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(qualifier_from_transaction_test)
    {
        ...
        CScript newQualifierScript = GetScriptForDestination(DecodeDestination(GetBurnAddress(AssetType::ROOT)));
        ...
        BOOST_CHECK_MESSAGE(address == GetBurnAddress(AssetType::ROOT), "Qualifier Tests: Failed address check");
    }
