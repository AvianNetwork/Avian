...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler avn tx
        CScript avnTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut avnOut(1*COIN, avnTransfer);
        ...
        mutTxTest1.vout.emplace_back(avnOut);
        ...
        mutTxTest2.vout.emplace_back(avnOut);
        ...
        mutTxTest3.vout.emplace_back(avnOut);
        ...
        mutTxTest4.vout.emplace_back(avnOut);
        ...
        mutTxTest5.vout.emplace_back(avnOut);
        ...
        mutTxTest6.vout.emplace_back(avnOut);
        ...
        mutTxTest7.vout.emplace_back(avnOut);
        ...
        mutTxTest8.vout.emplace_back(avnOut);
