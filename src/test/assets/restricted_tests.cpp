...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(restricted_from_transaction_test)
    {
        ...
        CScript newRestrictedScript = GetScriptForDestination(DecodeDestination(GetBurnAddress(AssetType::ROOT)));
        ...
        BOOST_CHECK_MESSAGE(address == GetBurnAddress(AssetType::ROOT), "Restricted Tests: Failed address check");
    }
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        CScript rvnTransfer = GetScriptForDestination(DecodeDestination(GetBurnAddress(AssetType::ROOT)));
        ...
        CScript parentScript = GetScriptForDestination(DecodeDestination(GetBurnAddress(AssetType::ROOT)));
        ...
        CScript newRestrictedAssetOwnerScript = GetScriptForDestination(DecodeDestination(GetBurnAddress(AssetType::ROOT)));
