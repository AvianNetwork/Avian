...
BOOST_FIXTURE_TEST_SUITE(asset_reissue_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(reissue_cache_test_ipfs)
    {
        ...
        BOOST_CHECK_MESSAGE(cache.mapAssetsAddressAmount.at(make_pair("AVNASSET", Params().GlobalBurnAddress())) == CAmount(101 * COIN), "Reissued amount wasn't added to the previous total");
        ...
        BOOST_CHECK_MESSAGE(cache.mapAssetsAddressAmount.at(make_pair("AVNASSET", Params().GlobalBurnAddress())) == CAmount(100 * COIN), "Assets total wasn't undone when reissuance was");
    }
