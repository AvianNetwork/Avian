...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK(!ParseMoney("21000000001.00"));
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    const std::array<unsigned char, 32> privkey_bytes = {
        ...
        // derived address from this private key: RDUd2mXG2e58QWX8bTmR21y7VG5vnH5c2n
    ...
    const std::string expected_signature =
        "IGYH4NpAQJiN8kNwYXsErfpz0Hhapdz75J2eaXRG18KiaypPgvXE1IRxdx+M3eJFOX8akZIMZU2Z78Cpe2wFGfg=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "rS7kK7NY7rHL6fMKZxtWttY33pvhfLacYM",
            "signature should be irrelevant",
            "message too"),
