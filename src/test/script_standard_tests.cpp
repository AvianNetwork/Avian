...
BOOST_AUTO_TEST_CASE(script_standard_ExtractDestination)
{
    ...
    s.clear();
    // -> segwit v2 is the defined ML-DSA-44 type on Avian; versions 3+ are unknown
...
// Taproot builder and BIP341 script-path vectors are omitted: taproot is not a
// supported spend feature on Avian (RIP-25 uses witness v2 for post-quantum).
