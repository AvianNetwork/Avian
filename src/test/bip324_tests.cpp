...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    // BIP324 key derivation folds the network magic into the HKDF salt, so these vectors are
    // specific to Avian's mainnet magic (RVLM) and differ from Bitcoin's published vectors in
    // every network-dependent output column (garbage terminators, session id, ciphertext). We
    // therefore select mainnet params here.
    SelectParams(ChainType::MAIN);

    // The inputs are carried over verbatim from Bitcoin's packet_encoding_test_vectors.csv; the
    // output columns were recomputed with Avian's magic by test/functional/gen_bip324_avian.py.
    TestBIP324PacketVector(
        ...
        "",
        false,
        "19bb76bc2b9789005d02c4cb6931dd05",
        "f0546d637af8c84f8be941d98ec21304",
        "6622dbfddd2dc853ab5dc1c9e01f5d91ab5d43e92d8cd47e7bb1d6d688db3727",
        "f448eb3ae962d8da328c8214c168170883c6e66372",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "b34703a437d9f69a39a1e5cae8d9d9c4",
        "24225278a28ec46beee8d44a3e05fcee",
        "13bab255e51901d8e836966013192004d39a5fe931c5595cd61a94e07ea9c7a5",
        "a3c526a0c9d153fbdbede551de70e9a816954227c107ff5d2c251338c706a14cde53185e06",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "32b3cefd132f0e24fe5bb7f61ee80fd2",
        "4c708b5da2c27d015198b3d701be2f54",
        "9d8c23f69891184f76ee547131118437b396e082c75812c4571dc3a25783e7fc",
        "474950492d4d8f2c14d11164c8c791f74756033fde0c1ab8a9004ded61129bc90b8177d69fb70f56fc9e6900ca206485a554f981d445e4f603cf20932ba6026b5e47734667dc7fadc0c1aabb13e00341b56aea",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "ce2879720cb51d57d339ed0474e47622",
        "5f6e35b111571e09af6c6613cb78bd65",
        "29b70d4085e2a6a1e8a514e89eafbeb957480df829f7f40a66703407ba430413",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "67268c97154680d9bd35ac4c917764e6",
        "f5fb6e3fbc36910d7413a7085fca5060",
        "2aa7b27a9f1de353f44041c117bd4cda2356d1e43d09774fc10d6b573c7dedeb",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "710fc612ca28f7140355f9dee2405c49",
        "c72f18ea21413c2ba056007ca8bb8689",
        "0517fb32912d5effd6784c9a1d522a58abdef19220b68492567435c2c59ff6e1",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "7004300bb604d4f25782d0b321d5bcd8",
        "5d6d872442377ecd69685d82b00e2ffb",
        "e5765f82d1c5eb404d5268e4156d4cbd128c4bc0e72e8da9b451e5eaf48071d4",
        "",
        "");
}
