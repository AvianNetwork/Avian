...
public:
    ...
    // avian-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // avian-node accepts the option, and avian-gui accepts all avian-node
