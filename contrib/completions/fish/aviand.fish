...
complete --command aviand --no-files

# Extract options
function __fish_aviand_get_options
...
complete \
    --command aviand \
    --arguments "(__fish_aviand_get_options --nofiles)"
