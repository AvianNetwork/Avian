...
# Extract options
function __fish_avian_tx_get_options
...
# Extract commands
function __fish_avian_tx_get_commands
...
complete \
    --command avian-tx \
    --condition "not __fish_avian_seen_cmd (__fish_avian_tx_get_commands --commandsonly)" \
    --arguments "(__fish_avian_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command avian-tx \
    --arguments "(__fish_avian_tx_get_commands)" \
    --no-files
