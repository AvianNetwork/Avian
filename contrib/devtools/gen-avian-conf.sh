...
AVIAND=${AVIAND:-$BINDIR/aviand}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/avian.conf}

[ ! -x "$AVIAND" ] && echo "$AVIAND not found or not executable." && exit 1

DIRTY=""
VERSION_OUTPUT=$($AVIAND --version)
...
echo 'Generating example avian.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-avian-conf.sh.
##
