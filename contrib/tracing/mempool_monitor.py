...
""" Example logging Avian mempool events using the mempool:added,
...
def main(pid):
    ...
    # to the tracepoints
    aviand_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    aviand_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    aviand_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    aviand_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("USAGE: ", sys.argv[0], "<pid of aviand>")
        exit(1)
