...
"""Example logging Avian utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/aviand
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[aviand_with_usdts])
