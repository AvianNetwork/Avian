...
class WalletTest(AvianTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 AVN from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 AVN with subtract fee from amount
        ...
        # Sendmany 10 AVN with subtract fee from amount
