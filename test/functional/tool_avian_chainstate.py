...
class AvianChainstateTest(BitcoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_avian_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing avian-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    AvianChainstateTest(__file__).main()
