...
# TestNode: A peer we use to send messages to aviand, and store responses.
...
class CompactBlocksTest(AvianTestFramework):
    ...
    # This test actually causes aviand to (reasonably!) disconnect us, so do this last.
    ...
    # Test that aviand requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for aviand to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # aviand will not send blocktxn responses for blocks whose height is
